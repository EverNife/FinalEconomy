...
/**
 * Hytale entry point. The shared wiring lives in {@link FEBootstrap}; only publishing this plugin as
 ...
 */
@ECPlugin
public class FinalEconomyHytalePlugin extends ECHytalePlugin implements FEBootstrap {
