...
public class CMDEco {
    ...
    public void give(FCommandSender sender, @Arg("<Player>") FEPlayerData target,
        ...
        if (ConfigManager.settings.isNotifyOnEcoGive() && target.isPlayerOnline()) {
    ...
    public void take(FCommandSender sender, @Arg("<Player>") FEPlayerData target,
        ...
        if (ConfigManager.settings.isNotifyOnEcoTake() && target.isPlayerOnline()) {
    ...
    public void set(FCommandSender sender, @Arg("<Player>") FEPlayerData target,
        ...
        if (ConfigManager.settings.isNotifyOnEcoSet() && target.isPlayerOnline()) {
